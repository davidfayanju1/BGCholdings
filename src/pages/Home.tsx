    ...
    <>
      ...
      >
        ...
        >
          ...
          <motion.p
            {...fadeIn(0.6)}
            className="text-white/45 text-lg max-w-md leading-relaxed mb-12"
          >
          ...
          <motion.div {...fadeIn(0.8)} className="flex gap-6 flex-wrap">
            <Link
              to="/portfolio"
              className="text-[12px] tracking-widest uppercase px-8 py-4 bg-white text-black transition-all duration-300 hover:bg-white/85"
            >
              Our Portfolio
            </Link>
            <Link
              to="/strategy"
              className="text-[12px] tracking-widest uppercase px-8 py-4 border transition-all duration-300 text-white/60 hover:text-white hover:border-white/40"
        ...
        <motion.div
          ...
          className="absolute bottom-8 right-12 flex flex-col items-center gap-3 z-10"
        >
          <motion.div
            animate={{ y: [0, 8, 0] }}
            transition={{ repeat: Infinity, duration: 1.8, ease: "easeInOut" }}
            className="w-px h-16 bg-linear-to-b from-white/25 to-transparent"
          />
        </motion.div>
      </section>
      ...
      <section className="py-32 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2
            className="text-5xl md:text-6xl font-light text-white leading-tight max-w-2xl"
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.07)" }}>
          {services.map(({ number, title, desc }, i) => (
            ...
            >
              ...
              <h3
                className="md:col-span-4 text-2xl font-light text-white/80 group-hover:text-white transition-colors duration-300"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                {title}
              </h3>
        ...
        >
          <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full">
            ...
            >
              ...
              <Link
                to="/portfolio"
                className="text-[12px] tracking-widest uppercase inline-flex items-center gap-3 transition-all duration-300 group text-white/50 hover:text-white"
              >
                View Portfolio
      ...
      <section className="py-40 max-w-7xl mx-auto px-6 lg:px-12 text-center">
        <motion.div
          ...
          transition={{ duration: 0.9, ease: EASE_OUT }}
        >
          <p className="text-[11px] tracking-[0.4em] uppercase mb-6 text-white/30">
            Register Under BGC
          </p>
          <h2
          ...
          <Link
            to="/contact"
            className="text-[13px] tracking-widest uppercase px-10 py-5 border transition-all duration-500 hover:bg-white hover:text-black inline-block"
            style={{
