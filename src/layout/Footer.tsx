  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/35 text-sm leading-relaxed max-w-xs">
              A Nigeria-based investment holding company that manages and
              invests the funds of firms registered directly under it.
            </p>
          ...
          {/* Navigation */}
          <div>
            <p className="text-[11px] tracking-[0.25em] uppercase text-white/25 mb-5">
              Navigate
            </p>
        ...
        >
          ...
          <div className="flex gap-8">
            {["Privacy Policy", "Terms of Use", "Disclosures"].map((item) => (
              <span
                key={item}
                className="text-white/15 text-xs tracking-wide hover:text-white/35 transition-colors cursor-pointer"
              >
                {item}
              </span>
            ))}
        ...
        <p
          className="text-white/12 text-[11px] leading-relaxed mt-8 max-w-4xl"
          style={{ color: "rgba(255,255,255,0.1)" }}
        >
          BGC Holdings is a Limited Liability Company registered in Nigeria.
          Information on this website is for informational purposes only and
          does not constitute an offer to sell or solicitation to buy
          securities. Investment opportunities are limited to firms registered
